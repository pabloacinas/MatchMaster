...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        ligas = LigaManager.getInstance().getLigasGuardadas();
    ...
    private void abrirLigaDetalle(Liga liga) {
        LigaCompleta ligaCompleta = LigaManager.getInstance().getLigaCompletaPorId(liga.getId());
    ...
    private void eliminarLiga(Liga liga) {
        ...
        LigaManager.getInstance().eliminarLiga(liga.getId());
